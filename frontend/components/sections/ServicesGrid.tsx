      ...
      <div className="mx-auto max-w-[1140px]">
        ...
        <div className="mt-10 grid gap-[30px] sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service, i) => (
            <Reveal key={service.id} delay={Math.min(i, 5) * 80}>
              <div className="group relative overflow-hidden rounded-[4px] bg-white p-5 shadow-[0px_5px_83px_0px_rgba(40,40,40,0.04)] transition-transform duration-300 hover:-translate-y-[5px] md:p-[30px]">
                {service.image && (
