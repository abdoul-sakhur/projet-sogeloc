...
export interface ApiHeroSlideHeroSlide extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Slides du carrousel principal de la page d'accueil";
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Pages principales du site, construites avec des sections dynamiques';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Projets et r\u00E9alisations de l'entreprise";
    displayName: 'Project';
    pluralName: 'projects';
...
export interface ApiSiteSettingsSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    social: Schema.Attribute.Component<'shared.social-links', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
